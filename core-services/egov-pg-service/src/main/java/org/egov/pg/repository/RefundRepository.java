...
public class RefundRepository {
	...
	public List<Refund> fetchRefundTransactionsByTimeRange(RefundCriteria refundCriteria, Long startTime, Long endTime) {
		List<Object> params = new ArrayList<>();
		String query = RefundTransactionQueryBuilder.getRefundSearchQueryByCreatedTimeRange(refundCriteria, startTime, endTime, params);
		return jdbcTemplate.query(query, params.toArray(), rowMapper);
	}
